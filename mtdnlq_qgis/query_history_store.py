...
class QueryHistoryStore:
    ...
    def save_success(self, question: str, response: dict) -> str | None:
        ...
        manifest = {
            ...
            "source_schema": response.get("source_schema"),
            "source_table": response.get("source_table"),
            "style_qml": response.get("style_qml"),
            "style_name": response.get("style_name"),
    ...
    def load_response(self, capsule_id: str) -> dict[str, Any] | None:
        ...
        return {
            ...
            "style_qml": manifest.get("style_qml"),
            "style_name": manifest.get("style_name"),
